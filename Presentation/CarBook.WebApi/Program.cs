...
using CarBook.Application.Interfaces.CarPricingsInterfaces;
...
using CarBook.Persistence.Repositories.TagCloudsRepositories;
...
builder.Services.AddScoped(typeof(IGenericRepository<>), typeof(CommentRepositroy<>));
...
builder.Services.AddScoped<GetLast5CarsWithBrandHandler>();


builder.Services.AddScoped<GetContactyQueryHandler>();
